...
function generateSidebar(chapters) {
    ...
    heading.textContent = "GD&T ASME Y14.5 2009 from 1994 Update Course";
...
function playVideo(videoSrc, videoDiv, chapterIndex, videoIndex) {
    ...
    const basePath = 'GD&T ASME Y14.5 2009 from 1994 Update Course/'; // Adjust this if your videos folder is in a different location
